...
<head>
    ...
    <style>
       ...
       .cancel-link { 
           text-decoration: none; color: #6c757d; font-size: 16px; 
...
<body>
    <div class="form-container">
        ...
        <!-- Form sends data to BookServlet (mapped as "admin") -->
        <form action="admin" method="POST" enctype="multipart/form-data">
        
            <!-- Hidden field to tell the servlet the action -->
            ...
            <div class="form-group">
                ...
                <input type="text" id="category" name="category" placeholder="e.g. Fiction, Technology, Education">
            </div>
            ...
            <!-- Book Image -->
            <div class="form-group">
                <label for="imageFile">Book Cover Image (Optional):</label>
                <input type="file" id="imageFile" name="imageFile" accept="image/*">
            </div>
            
            <div class="button-group">
                <button type="submit" class="button save-button">Save Book</button>
                <a href="index2.jsp" class="cancel-link">Cancel</a>
            </div>
        </form>
    </div>
</body>

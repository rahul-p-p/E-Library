<div class="container-fluid p-3" style="background-color: #edebeb">
	<div class="row">
		...
		<div class="col-md-2 mx-5">
			...
			<a href="register.jsp" class="btn btn-success">Signup</a>
		</div>
	</div>
</div>
  ...
  <div class="container-fluid">
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li class="nav-item">
         <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-book"></i>Books</a>
       </li>
       <li class="nav-item">
       ...
       <li class="nav-item">
         <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-circle-info"></i>About</a>
       </li>
     </ul>
     
     <form class="form-inline my-2 my-lg-0">
		<button class="btn btn-outline-light" type="submit"><i class="fa-solid fa-message"></i>Contact Us</button>
		<button class="btn btn-outline-light" type="submit"><i class="fa-solid fa-gear"></i>Setting</button>
	 </form>
    </div>
  </div>
</nav>